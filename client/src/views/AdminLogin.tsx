...
const AdminLogin = (props: Props) => {
  ...
  const submitRegistration = async (e: FormEvent) => {
    ...
    try {
      const response = await axios.post("/api/admin/login", newUserCredentials);
      ...
      <section className="h-screen">
        <div className="h-full">
          <div
            ...
            <div className="mb-16 border border-2 border-black pt-20 pb-20 pl-8 pr-8 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12 mr-12">
              <h1>Admin Login</h1>
